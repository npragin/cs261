...
class BST:
    ...
    def _remove_no_subtrees(self, remove_parent: BSTNode, remove_node: BSTNode) -> None:
        ...
        if remove_parent is None:
            ...
            raise BSTException("_remove_no_subtrees ", remove_parent, remove_node)
    ...
    def _remove_one_subtree(self, remove_parent: BSTNode, remove_node: BSTNode) -> None:
        ...
        if remove_parent is None:
            ...
            remove_parent.right = remove_node.left or remove_node.right
        else:
            raise BSTException("_remove_one_subtree ", remove_parent, remove_node)
    ...
    def _remove_two_subtrees(self, remove_parent: BSTNode, remove_node: BSTNode) -> None:
        ...
        elif parent.right is itr:
            parent.right = itr.right
        else:
            raise BSTException("_remove_two_subtrees ", remove_parent, remove_node)
    ...
    def inorder_traversal_rec(self, node: BSTNode, q: Queue):
        if node is None:
            return
        self.inorder_traversal_rec(node.left, q)
        q.enqueue(node.value)
        self.inorder_traversal_rec(node.right, q)
