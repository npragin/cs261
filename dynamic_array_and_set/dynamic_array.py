...
class DynamicArray:
    ...
    def reduce(self, reduce_func, initializer=None) -> object:
        """
        Applies reduce_func to all elements, returning the result. Optional initializer
        """
...
def find_mode(arr: DynamicArray) -> tuple[DynamicArray, int]:
    """
    Given a sorted DA, returns a tuple: DA of mode(s) and their highest frequency
    """
    modes = DynamicArray()
    maxCount = count = 1
